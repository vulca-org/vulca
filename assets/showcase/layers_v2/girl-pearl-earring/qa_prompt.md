    # QA Review Task — girl-pearl-earring
    ...
    ## Context
    - Domain: `baroque_painting`
    - Layers produced: 11
    - Status: `ok` (3/3 detected)

    ## Layers
    - z= 0 **dark_bg** (background)
- z=46 **girl__cloth** (subject.person[0].cloth)
- z=48 **girl__neck** (subject.person[0].neck)
- z=50 **girl** (subject.person[0])
- z=52 **girl__skin** (subject.person[0].skin)
- z=53 **girl__hat** (subject.person[0].hat)
- z=58 **girl__eyebrows** (subject.person[0].eyebrows)
- z=60 **girl__nose** (subject.person[0].nose)
- z=62 **girl__eyes** (subject.person[0].eyes)
- z=62 **girl__lips** (subject.person[0].lips)
- z=80 **pearl_earring** (foreground.jewelry)

...
\begin{center}
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}p{2.4cm}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}p{2.8cm}@{}}
\toprule
\rowcolor{tableHead}
...
\TBD{此处插入三组市场规模数据：(1)全球 agent 市场规模（Gartner / a16z 2026 最新口径）；
(2)全球多模态图像工具市场规模；(3)国内文化资产数字化产业市场规模（信通院 / 国家文物局口径）。
我们建议三项都引用\keyword{有官方背书的公开来源}，避免使用投资人难以验证的内部估算。}

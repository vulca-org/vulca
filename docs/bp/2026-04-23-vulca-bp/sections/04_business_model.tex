...
\heiti 价格 & Apache 2.0 免费 & \TBD{月订阅 ¥ / 席 / 月} + \TBD{文化评估 API ¥ / 次} & \TBD{首年许可 ¥ + 年度维护 ¥} \\
\heiti 交付 & GitHub + PyPI & 全托管 & 驻场实施 + 远程维护 \\
\heiti 毛利 & 0（战略投入） & \TBD{$\ge$ 70\%（推荐）} & \TBD{$\ge$ 50\%（推荐）} \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{itemize}
  \item GitHub star \TBD{目标：1500–3000（保守）}；
  \item PyPI 月下载量 \TBD{目标：月均 5000+};
...
\begin{center}
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}p{2.6cm}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}p{2.4cm}@{}}
\toprule
\rowcolor{tableHead}
...
学术会议 & ACM MM 2026 EmoArt Challenge 提交 + 参会 & \TBD{差旅 ¥} \\
\bottomrule
\end{tabularx}
\end{center}
...
\begin{enumerate}
  ...
  \item \TBD{政府部门 / 国家级文化数字化试点项目的直接对接渠道，需要你补充目前已有的资源。}
\end{enumerate}

...
\heiti 价格 & Apache 2.0 免费 & ¥ 299 / 席 / 月（Team tier）+ ¥ 0.5 / 次（批量 API） & ¥ 30–80 万首年许可 + ¥ 12–24 万 / 年维护 \\
\heiti 交付 & GitHub + PyPI & 全托管 & 驻场实施 + 远程维护 \\
\heiti 毛利 & 0（战略投入） & $\ge$ 70\% & $\ge$ 50\% \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{itemize}
  \item GitHub star 目标 1500–3000（保守口径）；
  \item PyPI 月下载量目标月均 5000+；
...
学术会议 & ACM MM 2026 EmoArt Challenge 提交 + 参会 & ¥ 15–20 万 / 年（覆盖国际会议与国内行业会议差旅预算） \\
\bottomrule
\end{tabularx}
\end{center}

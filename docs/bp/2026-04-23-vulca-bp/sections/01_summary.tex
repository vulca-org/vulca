...
\begin{itemize}
  ...
  \item \fact{技术基线}{21 个 MCP 工具 \textperiodcentered{} 1454 个测试全绿 \textperiodcentered{} Phase 0 和 Phase 1 均已完成}
  ...
  \item \fact{文化评估}{覆盖中国工笔、中国写意、日本传统、伊斯兰几何、西方学院、南亚、非洲、摄影、水彩、品牌设计、UI/UX、当代艺术等 13 种艺术与设计传统的 L1–L5 可引用评价准则}
  \item \fact{学术背书}{承接 ACM MM 2026 EmoArt Challenge（2026-06-10 提交），Track 1 基于 Vulca 技术栈}
  \item \fact{早期社区信号}{GitHub 插件生态（\code{vulca-org/vulca-plugin}）\textperiodcentered{} dev.to + 小红书双语种子内容已发布 \textperiodcentered{} 流量与下载数据周期性复盘}
\end{itemize}
...
\begin{itemize}
  ...
  \item \fact{募资金额}{\TBD{本轮募资金额区间，例如 ¥500–800 万}}
  \item \fact{估值口径}{\TBD{post-money 估值，例如 ¥3000–5000 万}}
...
\begin{itemize}
  \item \keyword{技术已验证}：21 个工具 + 1454 测试 + 3 个端到端 skill 全部 shipped，不是 PPT 项目；

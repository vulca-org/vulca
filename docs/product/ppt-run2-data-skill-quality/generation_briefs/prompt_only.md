...
Use the commercial brief only. Do not use multimodal database, visual learning targets, visual target components, evidence memory, aesthetic memory, asset memory, source cards, video cards, Run 1.5 skill files, or Run 2.0 skill files.

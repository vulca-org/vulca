...
function ScriptNodeComponent({ data, selected }: NodeProps & { data: ScriptNodeData }) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-1.5 px-2 py-1.5 border-b border-gray-100 dark:border-gray-700">
        ...
        <span className="text-[10px] font-semibold text-gray-700 dark:text-gray-300">Storyboard</span>
      </div>
      <div className="p-2">
        <textarea
          value={text}
          ...
          placeholder="Scene 1: ..."
          className="w-full h-16 text-[10px] bg-gray-50 dark:bg-gray-700 rounded p-1.5 resize-none outline-none text-gray-700 dark:text-gray-300 placeholder-gray-400 font-mono"
        />
      </div>
      <Handle
        type="source"

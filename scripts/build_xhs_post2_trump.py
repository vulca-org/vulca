...
from xhs_common import (
    ACCENT, BG_DARK, H, MUTED, W, WHITE,
    checker_bg, cn_locale, compose_photo, fit_contain, fit_cover,
...
def slide_06_mugshot_anatomy():
    ...
    make_anatomy_grid(
        ...
        top_title="五官自动解剖", top_sub="face parts · mugshot",
        bot_text="mugshot 也能拆出 6 层",
        bot_sub="SegFormer on booking photo",
    )
    print("✓ 06-mugshot-anatomy.png")
